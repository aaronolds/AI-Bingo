...
## Acceptance Criteria
- [ ] AppHost defines a Postgres resource managed by Aspire.
- [ ] Running the distributed app starts Postgres automatically.
- [ ] Connection information is discoverable by services via Aspire wiring (no manual env var docs required beyond “run CLI”).

## Implementation Tasks
- [ ] Add Postgres resource using Aspire CLI.
- [ ] Configure persistence/volume defaults as appropriate for dev.
- [ ] Verify Postgres shows up in the Aspire dashboard.
